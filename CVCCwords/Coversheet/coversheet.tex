...
\draw [draw=none,fill=red!50!blue] 
...
\draw[draw=none,fill=purple!80] ($(current page.south west)+(1.5,22.75)$) rectangle ($(current page.north east)+(-1.5,-2.75)$);
...
\node[scale=3] at ($(current page.center)+(0,7)$) 
	{\Huge \bf {\fontfamily{qag}\selectfont CVCC}};
\node[scale=3] at ($(current page.center)+(0,4)$) 
	{\Huge \bf {\fontfamily{qag}\selectfont Words}};


\draw[draw=none,fill=purple!80,opacity=0.75] (-4,-24) rectangle (-1,-15);
\draw[draw=none,fill=purple!80,opacity=0.75] (2,-24) rectangle (5,-21);
\draw[draw=none,fill=purple!80,opacity=0.75] (5,-24) rectangle (8,-18);
\draw[draw=none,fill=purple!80,opacity=0.75] (8,-24) rectangle (11,-21);
\draw[draw=none,fill=purple!80,opacity=0.75] (11,-24) rectangle (14,-15);
